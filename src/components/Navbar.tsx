      ...
      <nav className="navbar">
        <div className="navbar-inner">
          <button className="logo-btn" onClick={() => handleNav('home')}>
            ...
            <span className="logo-text">{siteContent.brand.name}</span>
          </button>
          ...
          <div className="nav-controls">
            <button className="control-btn" onClick={toggleTheme} title={siteContent.labels.themeToggle}>
              {theme === 'light' ? (
            ...
            <button
              ...
              aria-label={siteContent.labels.mobileMenu}
            >
              {mobileOpen ? (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
